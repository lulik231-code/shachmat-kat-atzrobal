...
const RegisterChildPage = () => {
  ...
  const [form, setForm] = useState({ fullName: '', email: '', password: '', gardenId: '' });
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div>
            ...
            {loadingGardens ? (
              ...
              <div style={{ color: 'var(--accent-red)', fontSize: '0.9rem', padding: '10px' }}>
                אין גנים מאושרים כרגע
              </div>
            ) : (
              <select
                className="input-field"
